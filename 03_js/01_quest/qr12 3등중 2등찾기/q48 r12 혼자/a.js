...
// 랜덤 번호들
r[0] = 1;//Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
document.write(r[0]);
document.write("<br>");
...
while(true){
    ...
    r[1] = 2; // Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while(true){
    ...
    r[2] = 3; //Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while(true){
    ...
    r[3] = 4; //Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while(true){
    ...
    r[4] = 5; //Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while(true){
    ...
    b = 6; //Math.floor(Math.random() * 45) + 1; // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
} // []안에 0~5사이에 수가 일치할때 win이 한개씩추가되어 맞춘수가 늘어난다.
